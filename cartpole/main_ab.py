            ...
            for c in C:
                ...
                for i in range(runs):
                    ...
                    pd.DataFrame(data).to_csv(
                        '/Users/d/work/Human/CartPole_OLD/data/AB/data_' +  str(l) + '_'+ str(c) + '_'+ str(r) + '_' +  str(i) + '_'  + str(MAX_EPISODE) + '.csv', header=dict)
...
#                     # pickle.dump(total_reward, open('pic/feedback/AB/data_%.1f_%.1f_%.1f.pkl' % (l, r, c), 'wb'))
#
#
#                     reward_means = acverRange(episode_reward)
#
...
#                     pd.DataFrame(data)
#                     pd.DataFrame(data).to_csv(
#                         '/Users/d/work/Human/CartPole_OLD/data/control_sharing/data_' +  str(l) + '_'+ str(c) + '_'+ str(r) + '_' +  str(i) + str(MAX_EPISODE) + '.csv', header=dict)
#
#                 agent.close()